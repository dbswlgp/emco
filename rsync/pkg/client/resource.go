...
func (c *Client) GetPodMetrics(ctx context.Context) {

	podMetrics, _ := c.Clientsetformetrics.MetricsV1beta1().PodMetricses("default").List(ctx, metav1.ListOptions{})
	fmt.Println("\n\n")
...
func (c *Client) GetAvailableNodeResources(ctx context.Context, resName string) (int64, int64, map[string]int64, error) {
	...
	podList, _ := c.GetPodList(ctx, "cluster5-2")
	fmt.Println("\n\n")
