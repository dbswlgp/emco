...
import (
	...
	hpaMod "gitlab.com/project-emco/core/emco-base/src/migration/pkg/module"
...
func init() {
	migrationIntentJSONFile = "../json-schemas/placement-hpa-intent.json"
...
var _ = Describe("TestHpaApi ***", func() {
	...
	var (
		...
		migrationIntentName1   string = "testIntent"
	...
	It("*** GINKGO API TESTCASE: successful create allocatable resource ***", func() {
		...
		(mdb.Items[0])[hpaMod.HpaConsumerKey{ConsumerName: hpaConsumerName1, IntentName: migrationIntentName1,
			Project: project, CompositeApp: compApp,
			Version: version, DeploymentIntentGroup: digroup}.String()] = map[string][]byte{
			"data": []byte(
				"{" +
